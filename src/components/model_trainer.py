...
def load_data_and_preprocessor(train_path, test_path):
    try:
...
def train_and_evaluate_model(train_arc, test_arc):
    try:
...
if __name__ == '__main__':
    ...
    train_arc, test_arc, preprocessing_obj_path = load_data_and_preprocessor(train_path, test_path)

    # Train and evaluate the model, and get the trained classifier
    accuracy, classification_rep, trained_classifier = train_and_evaluate_model(train_arc, test_arc)
